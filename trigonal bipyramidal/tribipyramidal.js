...
contentMap.set(sphere4, 'CARBON is a building block of life,forming diverse organic molecules.');
...
function onClick(event) {
  ...
  var intersects = raycaster.intersectObjects([sphere1, sphere2,sphere3,sphere4,sphere, cylinder1,cylinder2,cylinder3,cylinder4]);
