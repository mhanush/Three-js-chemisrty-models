...
const sphere5=new THREE.Mesh(geometry.clone(),material.clone())
sphere5.position.set(0,-16,0);
...
const cylinder6=new THREE.Mesh(c1geometry.clone(),c1material.clone());
cylinder6.position.set(0,-8,0);

const smaterial2 = new THREE.MeshBasicMaterial( { color: 0xff0000 } ); 
const sphere6=new THREE.Mesh(geometry.clone(),smaterial2)
...
contentMap.set(sphere5, 'HYDROGEN is the simplest element, abundant and reactive in chemical processes.');
contentMap.set(sphere6, 'CARBON is a building block of life,forming diverse organic molecules.');
...
contentMap.set(cylinder6, 'BONDING is atoms joining to form molecules by sharing or transferring electrons.');
...
function onClick(event) {
  ...
  var intersects = raycaster.intersectObjects([sphere1, sphere2,sphere3,sphere4,sphere5,sphere6, cylinder1,cylinder2,cylinder3,cylinder4,cylinder5,cylinder6]);
